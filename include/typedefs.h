...
typedef enum E_TYPE {
    E_UNDEFINED, E_INT, E_REAL, E_CHAR, E_BOOL, E_ARRAY, E_RECORD, E_FUNCTION, E_PROCEDURE
} E_TYPE;
...
typedef struct ProcedureData { // ??? precisa ser uma struct diferente entre function e procedure?
    TypeNamePair* params;
    // ??? comandos ???
